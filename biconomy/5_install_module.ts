...
// tutorial https://docs.biconomy.io/modules#how-to-enable-modules

const isEnabled = await account.isModuleEnabled(module_address)
if (!isEnabled) {
	const enableModuleTrx = await account.getEnableModuleData(module_address)
	transactionArray.push(enableModuleTrx)
}
account = account.setActiveValidationModule(module)
